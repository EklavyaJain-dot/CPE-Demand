...
document.getElementById("text").innerHTML = userquestion[input] + "<br>";
    ...
    document.getElementById("text").innerHTML = "It would be byond my abilities at the moment. You can talk to the given mobile number:121232343";
}
...
document.getElementById("text").innerHTML = userquestion[input] + "<br>";
    ...
    document.getElementById("text").innerHTML = "It would be beyond my abilities at the moment. You can talk to the given mobile number:1212323434";
}
